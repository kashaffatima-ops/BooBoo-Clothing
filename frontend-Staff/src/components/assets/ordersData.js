...
let order_list = [
  {
    ...
    orderdProductsList: [
      { product: data_product.at(1), quantity: 6 },
      { product: data_product.at(2), quantity: 5 },
    ],
  },
  {
    order_id: 102,
    ...
    orderdProductsList: [
      { product: data_product.at(3), quantity: 2 },
      { product: data_product.at(4), quantity: 4 },
    ],
  },
  {
    order_id: 103,
    ...
    orderStatus: "shipped",
    orderdProductsList: [
      { product: data_product.at(5), quantity: 1 },
      { product: data_product.at(6), quantity: 3 },
    ],
  },
  {
    order_id: 104,
    ...
    orderdProductsList: [
      { product: data_product.at(7), quantity: 2 },
      { product: data_product.at(8), quantity: 4 },
    ],
  },
  {
    order_id: 105,
    ...
    orderStatus: "received",
    orderdProductsList: [
      { product: data_product.at(9), quantity: 1 },
      { product: data_product.at(10), quantity: 6 },
    ],
  },
  {
    order_id: 106,
    ...
    orderStatus: "delivered",
    orderdProductsList: [
      { product: data_product.at(11), quantity: 3 },
      { product: data_product.at(12), quantity: 2 },
    ],
  },
  {
    order_id: 107,
    ...
    orderStatus: "shipped",
    orderdProductsList: [
      { product: data_product.at(13), quantity: 2 },
      { product: data_product.at(14), quantity: 2 },
    ],
  },
  {
    order_id: 108,
    ...
    orderStatus: "delivered",
    orderdProductsList: [
      { product: data_product.at(15), quantity: 3 },
      { product: data_product.at(16), quantity: 2 },
    ],
  },
  {
    order_id: 107,
